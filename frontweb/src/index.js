import { createRingPuzzle } from "./factories/RingPuzzleFactory.js"
const N_RINGS = 4;
...
function nextPuzzle() {
    if(id_actual < 2) {
        ...
        actual_puzzle = createRingPuzzle("../files/images/painting" + id_actual, N_RINGS, puzzlecontainer, 30);
        full_img = document.createElement("img");
        full_img.src = "../files/images/painting" + id_actual + "/full_painting.png";
